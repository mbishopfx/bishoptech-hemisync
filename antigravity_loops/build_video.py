...
if len(sys.argv) < 3:
    print("Usage: python3 build_video.py <slug-folder-path> <date-output-folder-name>")
    sys.exit(1)
...
frames_src_dir = os.path.join(base_dir, frames_folder_name)

print(f"Loading files from: {base_dir}")
print(f"Source frames directory: {frames_src_dir}")
