...
export function normalizeLibraryTone(tone = {}) {
  ...
  const playUrl = tone.mp3_url || tone.mp3Url || tone.wav_url || tone.wavUrl || null;
  ...
  return {
    ...
    sourceType: tone.sourceType || tone.source_type || 'user-saved',
    source_type: tone.source_type || tone.sourceType || 'user-saved',
    description: tone.description || tone.summary || '',
