...
<html lang="en">
  ...
  <body>
    <main class="phone-shell" data-phone-download-widget>
      ...
      <p class="note">The $0.50 route is an agent-payment handoff, not a direct browser charge. The Payment-Authorization credential stays with the compatible agent, and the server verifies the provider receipt before releasing a session.</p>
    </main>
    <script>
      (function () {
        'use strict';
