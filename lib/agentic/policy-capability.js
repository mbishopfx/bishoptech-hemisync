...
const POLICY_RECORDS = {
  ...
  ai: {
    ...
    path: '/ai-disclosure',
    effectiveDate: '2026-08-27',
    summary: 'AI may help match public tone intentions, shape private session drafts, or summarize and classify journal entries. AI output is not medical advice, treatment, crisis support, or a guarantee of any result.'
  },
  pricing: {
