...
export const WEBMCP_TOOL_DEFINITIONS = [
  ...
  },
  {
    ...
    description: 'Reveal the visible click-through Cognistration science guide for the current machine direction. It explains the two-channel signal, FFR, descriptive frequency bands, evidence limits, and safe listening; it never starts audio, saves a record, or includes diary content.',
