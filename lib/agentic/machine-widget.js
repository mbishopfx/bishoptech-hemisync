    ...
    <script>
      (function () {
        ...
        function applyHostGlobals(globals) {
          ...
          if (globals.widgetState && typeof globals.widgetState === 'object') applyControls(globals.widgetState);
          ...
          if (globals.toolOutput !== undefined) applyOutput(globals.toolOutput);
        }
        ...
        window.addEventListener('message', function (event) {
          ...
          if (message.type === 'ui/notifications/tool-result' || message.type === 'openai/widget-output') {
            applyOutput(message.result || message.output || message);
            return;
          }
