...
export const MACHINE_WIDGET_CAPABILITY_VERSION = '0.1.0';
export const MACHINE_WIDGET_RESOURCE_URI = 'ui://cognistration/machine-generator/v1.html';
...
export const MACHINE_WIDGET_RESOURCE_META = {
  ...
  'openai/widgetDescription': 'An interactive Cognistration tone machine. It lets the listener seed a session from an intention, tune a bounded carrier and rhythm, browse public tone packs, and start an explicit local audio preview.',
