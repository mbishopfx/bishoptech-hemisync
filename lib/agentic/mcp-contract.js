...
export const MCP_RESOURCES = [
  ...
  },
  {
    ...
    description: 'Click-through educational guide with a vGPU FFT ocean surface, a randomized bounded sea profile per run, a quiet FFT visual reference, signal notes, research boundaries, and a print/save-to-PDF path; it does not start audio.',
