...
// Only the open tool renders the iframe. Action tools are intentionally
// template-free so a model-issued control call is delivered to the currently
// mounted View instead of asking the host to create another one.
