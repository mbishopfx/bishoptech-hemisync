...
export const MCP_RESOURCES = [
  ...
  },
  {
    ...
    description: 'Click-through educational guide with the FFT ocean-surface visual, signal notes, research boundaries, and a print/save-to-PDF path; it does not start audio.',
