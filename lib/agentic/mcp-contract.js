...
export const MCP_RESOURCES = [
  ...
  },
  {
    ...
    description: 'Click-through educational guide with a self-contained animated ocean surface, a quiet FFT visual reference, signal notes, research boundaries, and a print/save-to-PDF path; it does not start audio.',
