...
export function tonePackPaymentOptions(origin = siteOrigin()) {
  ...
  return {
    ...
    input: 'Published tone-pack slug, delivery email, and confirmed=true. Send the MPP credential as Authorization: Payment <credential>; Payment-Authorization is also accepted for clients that reserve Authorization for app auth. Never put the credential in JSON.',
    delivery: {
      emailRequired: true,
