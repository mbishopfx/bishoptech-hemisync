...
import { getTonePackBySlug } from '@/lib/audio/tone-packs.mjs';
import { sendPackDeliveryEmail } from '@/lib/email/pack-delivery.mjs';
...
export async function fulfillTonePackPurchase({ stripeSession, supabase = getSupabaseAdmin() }) {
  ...
  const bundleUrl = catalogRow?.bundle_url || null;
