...
const aiCrawlerRules = [
  ...
  { userAgent: '*', allow: ['/', '/try', '/docs', '/api/mcp', '/api/mcp/server-card', '/api/capabilities', '/.well-known/mcp/manifest.json', '/.well-known/mcp/server-card.json', '/.well-known/mcp.json', '/mcp.json', '/openapi.json', '/agent-instructions.md'], disallow: ['/api/', '/dashboard', '/generate', '/login', '/signup'] }
];
