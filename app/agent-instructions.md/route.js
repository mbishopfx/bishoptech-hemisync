...
When a person wants to understand the generated settings, call open_science_guide after open_machine_generator or a tone result. The versioned resource ui://cognistration/science-guide/v1.html is a clickable seven-slide explanation with a self-contained animated ocean surface, a quiet FFT visual reference link, and a browser print/save-to-PDF action. It is educational only: no audio starts, no diary text is included, and no medical or diagnostic claim is made. If a host cannot render custom UI, return the structured result and explain the bounded fallback; do not automatically send the person away from the current surface.
