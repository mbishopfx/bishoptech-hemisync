          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <p className="max-w-3xl text-base leading-7 text-[var(--text-secondary)]">
                This dashboard is the working surface of Cognistration Studio. It is built to keep the audio workflow calm and professional: start with the goal, hear a sample, save your best render, and review it later.
              </p>
            </div>
            <div className="flex flex-wrap gap-3">
              <Button asChild>
