  ...
  return (
    <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
      ...
      <svg className="absolute bottom-[-4vh] left-0 right-0 h-[28vh] w-[200vw] opacity-60 blur-[1px]" viewBox="0 0 1440 320">
        <motion.path d={makePath(0, 30, 0.006)} fill="#38bdf8" fillOpacity="0.12" />
        <motion.path d={makePath(240, 26, 0.005)} fill="#06b6d4" fillOpacity="0.10" />
        <motion.path d={makePath(480, 22, 0.004)} fill="#0ea5e9" fillOpacity="0.08" />
      </svg>
      <svg className="absolute bottom-[-6vh] left-0 right-0 h-[22vh] w-[200vw] opacity-50 blur-[2px]" viewBox="0 0 1440 320">
        <motion.path d={makePath(120, 18, 0.006)} fill="#0891b2" fillOpacity="0.08" />
        <motion.path d={makePath(360, 16, 0.005)} fill="#0284c7" fillOpacity="0.08" />
      </svg>
    </div>
  );
}
