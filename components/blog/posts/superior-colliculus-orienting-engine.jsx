...
import { superiorColliculusOrientingEnginePostMeta } from "@/lib/blog/posts-data";

export const superiorColliculusOrientingEnginePost =
...
const sections = [
  {
    title: "The hook: orienting is the first draft of awareness",
    paragraphs: [
    ...
    callout: {
      label: "Big idea",
      text: "Attention is not just selection. It is a routing decision that tells the body where to face before consciousness has fully explained why.",
    },
  },
  {
    title: "The superior colliculus is a midbrain control surface, not a visual footnote",
    paragraphs: [
  ...
  {
    title: "Saccades are not interruptions. They are the rhythm of sampling",
    paragraphs: [
    ...
    callout: {
      ...
      text: "Saccades are not noise to be removed. They are part of the mechanism that makes a stable scene possible at all.",
    },
  },
  {
    title: "Covert attention and overt orienting share a common logic",
    paragraphs: [
    ...
    subheading: "The feeling of sudden relevance",
    subparagraphs: [
  ...
  {
    title: "The colliculus sits in a larger salience loop with brainstem and cortex",
    paragraphs: [
    ...
    callout: {
      ...
      text: "What feels like immediate awareness is often a coordinated chain of orienting, arousal, and sampling that begins below the level of explicit choice.",
    },
  },
  {
    title: "When orienting becomes unstable, the world feels too loud or too far away",
    paragraphs: [
...
const evidence = [
  {
    title: "Superior colliculus and visual attention — review",
    note:
      "A useful entry point for the role of the colliculus in reflexive orienting and attentional selection.",
    href: "https://pubmed.ncbi.nlm.nih.gov/?term=superior+colliculus+visual+attention+review",
  },
  {
    title: "Saccades, covert attention, and the orienting network — review",
    note:
      "Helpful for linking eye movement planning with the hidden logic of attention.",
    href: "https://pubmed.ncbi.nlm.nih.gov/?term=saccades+covert+attention+orienting+network+review",
  },
  {
    title: "Multisensory integration in the superior colliculus — review",
    note:
      "Shows how visual, auditory, and somatic cues can converge into a single orienting decision.",
    href: "https://pubmed.ncbi.nlm.nih.gov/?term=multisensory+integration+superior+colliculus+review",
  },
  {
    title: "The superior colliculus and reflexive orienting — review",
    note:
      "Useful for understanding why the first turn of awareness is often a bodily turn.",
    href: "https://pubmed.ncbi.nlm.nih.gov/?term=superior+colliculus+reflexive+orienting+review",
  },
  {
    title: "Covert orienting of visual attention — classic review",
    note:
      "A standard bridge between internal attention and overt sensorimotor allocation.",
    href: "https://pubmed.ncbi.nlm.nih.gov/?term=covert+orienting+visual+attention+review",
  },
  {
    title: "Orienting, salience, and arousal in the midbrain — review",
    note:
      "Useful for placing the colliculus inside a larger gain and alerting loop.",
    href: "https://pubmed.ncbi.nlm.nih.gov/?term=orienting+salience+arousal+midbrain+review",
  },
];
...
export default function SuperiorColliculusOrientingEnginePost() {
  return (
      ...
      <header className="relative overflow-hidden rounded-3xl border border-white/5 bg-zinc-900/40 backdrop-blur-3xl px-7 py-10 shadow-2xl md:px-10 md:py-12">
        ...
        <div className="relative max-w-4xl space-y-6">
          ...
          <h1 className="text-balance text-4xl font-light tracking-tight text-white md:text-6xl md:leading-[0.95]">
            {superiorColliculusOrientingEnginePost.title}
          </h1>
          <p className="max-w-3xl text-balance text-sm leading-relaxed text-white/50">
            {superiorColliculusOrientingEnginePost.excerpt}
          </p>
          <div className="flex flex-wrap gap-x-6 gap-y-2 text-[10px] font-mono uppercase tracking-[0.25em] text-white/30">
            <span>{superiorColliculusOrientingEnginePost.category}</span>
            <span>{superiorColliculusOrientingEnginePost.readTime}</span>
            <span>{new Date(superiorColliculusOrientingEnginePost.publishedAt).toLocaleDateString()}</span>
          </div>
        </div>
      </header>
      ...
      <section className="grid gap-6 rounded-3xl border border-white/5 bg-zinc-900/40 backdrop-blur-3xl p-7 shadow-xl md:grid-cols-[1.2fr_0.8fr] md:p-8">
        ...
        <div className="rounded-2xl border border-white/5 bg-zinc-950/40 p-5 text-xs leading-relaxed text-white/60">
          ...
          <ul className="mt-3 space-y-2">
            <li>• Attention feels jumpy, thin, or too easily captured.</li>
            <li>• You want to study what actually pulls the body into action.</li>
            <li>• You need a cleaner baseline for focus training or meditation.</li>
          </ul>
