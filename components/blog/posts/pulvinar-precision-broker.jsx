...
import { pulvinarPrecisionBrokerPostMeta } from "@/lib/blog/posts-data";

export const pulvinarPrecisionBrokerPost = pulvinarPrecisionBrokerPostMeta;
...
const sections = [
  {
    title: "The hook: consciousness begins as a priority decision",
    paragraphs: [
    ...
    callout: {
      label: "Big idea",
      text: "What feels like instant recognition is often the result of thalamic priority setting, not pure cortical interpretation.",
    },
  },
  {
    title: "The pulvinar is a coordination node, not a decorative relay",
    paragraphs: [
    ...
    subheading: "Why the word precision matters",
    subparagraphs: [
  ...
  {
    title: "Visual awareness depends on selective synchrony",
    paragraphs: [
    ...
    callout: {
      ...
      text: "A change in awareness does not always mean new content arrived. Sometimes it means old content was granted a different amount of precision.",
    },
  },
  {
    title: "Neglect, overload, and the failure to assign a center of gravity",
    paragraphs: [
  ...
  {
    title: "Conscious access is a conversation between thalamus and cortex",
    paragraphs: [
    ...
    subheading: "Why this looks like state change",
    subparagraphs: [
  ...
  {
    title: "When the pulvinars priorities drift, consciousness becomes expensive",
    paragraphs: [
    ...
    callout: {
      ...
      text: "What feels like concentration is often a successful reduction in routing friction across thalamocortical loops.",
    },
  },
  {
...
const evidence = [
  {
    title: "Pulvinar contributions to visual attention — PubMed review search",
    note:
      "A useful starting point for the pulvinar as a coordinator of attention, visual selection, and interregional communication.",
    href: "https://pubmed.ncbi.nlm.nih.gov/?term=pulvinar+visual+attention+review",
  },
  {
    title: "Pulvinar and functional connectivity in visual cortex — review search",
    note:
    ...
    href: "https://pubmed.ncbi.nlm.nih.gov/?term=pulvinar+functional+connectivity+visual+cortex+review",
  },
  {
    title: "Thalamic gating and precision weighting — review search",
    note:
      "Places the pulvinar inside the broader predictive-processing language of gain, precision, and selective access.",
    href: "https://pubmed.ncbi.nlm.nih.gov/?term=thalamic+gating+precision+weighting+review",
  },
  {
    title: "Visual neglect and thalamic attention networks — review search",
    note:
      "A clinical bridge between disrupted weighting and the failure to assemble a coherent scene.",
    href: "https://pubmed.ncbi.nlm.nih.gov/?term=visual+neglect+thalamic+attention+network+review",
  },
  {
    title: "Pulvinar, superior colliculus, and attentional selection — review search",
    note:
      "Useful for seeing how subcortical orienting and thalamic routing cooperate in the same priority loop.",
    href: "https://pubmed.ncbi.nlm.nih.gov/?term=pulvinar+superior+colliculus+attentional+selection+review",
  },
  {
    title: "Thalamocortical synchrony and consciousness — review search",
    note:
      "A broader context for why state shifts often begin as changes in coordination rather than changes in content.",
    href: "https://pubmed.ncbi.nlm.nih.gov/?term=thalamocortical+synchrony+consciousness+review",
  },
];
...
export default function PulvinarPrecisionBrokerPost() {
  return (
      ...
      <header className="relative overflow-hidden rounded-3xl border border-white/5 bg-zinc-900/40 backdrop-blur-3xl px-7 py-10 shadow-2xl md:px-10 md:py-12">
        ...
        <div className="relative max-w-4xl space-y-6">
          ...
          <h1 className="text-balance text-4xl font-light tracking-tight text-white md:text-6xl md:leading-[0.95]">
            {pulvinarPrecisionBrokerPost.title}
          </h1>
          <p className="max-w-3xl text-balance text-sm leading-relaxed text-white/50">
            {pulvinarPrecisionBrokerPost.excerpt}
          </p>
          <div className="flex flex-wrap gap-x-6 gap-y-2 text-[10px] font-mono uppercase tracking-[0.25em] text-white/30">
            <span>{pulvinarPrecisionBrokerPost.category}</span>
            <span>{pulvinarPrecisionBrokerPost.readTime}</span>
            <span>{new Date(pulvinarPrecisionBrokerPost.publishedAt).toLocaleDateString()}</span>
          </div>
        </div>
      </header>
      ...
      <section className="grid gap-6 rounded-3xl border border-white/5 bg-zinc-900/40 backdrop-blur-3xl p-7 shadow-xl md:grid-cols-[1.2fr_0.8fr] md:p-8">
        ...
        <div className="rounded-2xl border border-white/5 bg-zinc-950/40 p-5 text-xs leading-relaxed text-white/60">
          ...
          <ul className="mt-3 space-y-2">
            <li>• You want to observe how priority changes with context.</li>
            <li>• Your attention feels overloaded or underweighted.</li>
            <li>• You need a repeatable way to study conscious access without spectacle.</li>
          </ul>
