...
import { interoceptivePrecisionArbiterPostMeta } from "@/lib/blog/posts-data";

export const interoceptivePrecisionArbiterPost =
...
const sections = [
  {
    title: "The hook: the body decides before the narrative explains",
    paragraphs: [
    ...
    callout: {
      label: "Big idea",
      text: "Interoception does not just inform awareness. It helps select which version of the present feels trustworthy.",
    },
  },
  {
    title: "Interoceptive prediction is a control problem",
    paragraphs: [
    ...
    subheading: "Why internal signals can dominate a scene",
    subparagraphs: [
  ...
  {
    title: "The insula is where the body gets organized into felt certainty",
    paragraphs: [
    ...
    callout: {
      ...
      text: "The insula does not create emotion from nothing. It helps bind bodily state into conscious quality.",
    },
  },
  {
    title: "Autonomic tone sets the background authority of the body",
    paragraphs: [
    ...
    subheading: "Why calm is not the same as reduced signal",
    subparagraphs: [
  ...
  {
    title: "Breath is the most accessible handle on interoceptive precision",
    paragraphs: [
    ...
    callout: {
      ...
      text: "If the goal is precision, forcing very deep breathing can backfire by making the body too reactive.",
    },
  },
  {
    title: "Dissociation, anxiety, and absorption are precision states, not personality traits",
    paragraphs: [
...
const evidence = [
  {
    title: "Interoception and the body prediction problem — review",
    note:
      "A central entry point for understanding how the brain predicts internal bodily state.",
    href: "https://pubmed.ncbi.nlm.nih.gov/?term=interoception+body+prediction+review",
  },
  {
    title: "The insula and interoceptive awareness — review",
    note:
      "Useful for linking bodily evidence to subjective feeling and selfhood.",
    href: "https://pubmed.ncbi.nlm.nih.gov/?term=insula+interoceptive+awareness+review",
  },
  {
    title: "Predictive processing of interoception — review",
    note:
      "A clean bridge between bodily prediction error and conscious quality.",
    href: "https://pubmed.ncbi.nlm.nih.gov/?term=predictive+processing+interoception+review",
  },
  {
    title: "Heart rate variability, autonomic tone, and emotion regulation — review",
    note:
      "A practical way to understand how background physiology shapes the felt field.",
    href: "https://pubmed.ncbi.nlm.nih.gov/?term=heart+rate+variability+autonomic+tone+emotion+regulation+review",
  },
  {
    title: "Breathing and interoceptive precision — review",
    note:
      "Useful for connecting respiration to state control without mystical excess.",
    href: "https://pubmed.ncbi.nlm.nih.gov/?term=breathing+interoceptive+precision+review",
  },
  {
    title: "Dissociation, interoception, and self-processing — review",
    note:
      "Helps frame detachment and absorption as changes in bodily authority rather than mere mood.",
    href: "https://pubmed.ncbi.nlm.nih.gov/?term=dissociation+interoception+self-processing+review",
  },
];
...
export default function InteroceptivePrecisionArbiterPost() {
  return (
      ...
      <header className="relative overflow-hidden rounded-3xl border border-white/5 bg-zinc-900/40 backdrop-blur-3xl px-7 py-10 shadow-2xl md:px-10 md:py-12">
        ...
        <div className="relative max-w-4xl space-y-6">
          ...
          <p className="max-w-3xl text-balance text-sm leading-relaxed text-white/50">
            {interoceptivePrecisionArbiterPost.excerpt}
          </p>
          <div className="flex flex-wrap gap-x-6 gap-y-2 text-[10px] font-mono uppercase tracking-[0.25em] text-white/30">
            <span>{interoceptivePrecisionArbiterPost.category}</span>
            <span>{interoceptivePrecisionArbiterPost.readTime}</span>
            <span>{new Date(interoceptivePrecisionArbiterPost.publishedAt).toLocaleDateString()}</span>
          </div>
        </div>
      </header>
      ...
      <section className="grid gap-6 rounded-3xl border border-white/5 bg-zinc-900/40 backdrop-blur-3xl p-7 shadow-xl md:grid-cols-[1.2fr_0.8fr] md:p-8">
        ...
        <div className="rounded-2xl border border-white/5 bg-zinc-950/40 p-5 text-xs leading-relaxed text-white/60">
          ...
          <ul className="mt-3 space-y-2">
            <li>• You want to study body-led state change without speculation.</li>
            <li>• Presence feels either too flooded or too distant.</li>
            <li>• You need a cleaner read on what the nervous system is prioritizing.</li>
          </ul>
