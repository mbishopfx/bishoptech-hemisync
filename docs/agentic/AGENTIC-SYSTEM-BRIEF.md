...
| ChatGPT machine UI | `open_machine_generator` + `ui://cognistration/machine-generator/v1.html` | public render | The widget owns ephemeral controls and starts local audio only after an explicit click |
